...
function vybudujPismeno(pismeno){
	...
	if(pismeno == "HI") {
		...
		indexy[0] = [];
		indexy[1] = [1,2,6,7,9,10,11,12,13,14,15];
		indexy[2] = [1,2,6,7,9,10,11,12,13,14,15];
		indexy[3] = [1,2,6,7,11,12,13];
		indexy[4] = [1,2,3,4,5,6,7,11,12,13];
		indexy[5] = [1,2,3,4,5,6,7,11,12,13];
		indexy[6] = [1,2,3,4,5,6,7,11,12,13];
		indexy[7] = [1,2,6,7,11,12,13];
		indexy[8] = [1,2,6,7,9,10,11,12,13,14,15];
		indexy[9] = [1,2,6,7,9,7,10,11,12,13,14,15];
		indexy[10] = [];
